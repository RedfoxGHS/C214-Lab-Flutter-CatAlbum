...
[![Flutter CI](https://github.com/RedfoxGHS/cat_album_lab_flutter/actions/workflows/ci.yml/badge.svg)](https://github.com/RedfoxGHS/cat_album_lab_flutter/actions/workflows/ci.yml)

# cat_album_lab_flutter :smiley_cat:
App desenvolvido em flutter capaz de consumir uma api, onde pega fotos aleatorias de gatinhos :octocat:, para alegrar seu dia. :smile_cat:
...
| **Nome**        |
|-----------------|
| [Gabriel Henrique](https://github.com/RedfoxGHS)    |
